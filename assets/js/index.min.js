...
!(function (e, t) {
    ...
    function ae(e, t, n, i) {
      ...
      if (!i && (T(t), (t = t || S), k)) {
        ...
        if (
          ...
          if (((d = e), (u = t), 1 === p && (X.test(e) || _.test(e)))) {
            for (
  ...
  var W = function e(t, n, i, o, s, r, a) {
      var l = 0,
        c = t.length,
        d = null == i;
      if ("object" === w(i))
      ...
      return s ? t : d ? n.call(t) : c ? n(t[0], i) : r;
    },
    B = /^-ms-/,
    _ = /-([a-z])/g;
  function X(e, t) {
  ...
  C.extend({
    ...
    C.fn.extend({
      data: function (n, e) {
        ...
        return "object" == (void 0 === n ? "undefined" : _typeof(n))
          ? this.each(function () {
              Q.set(this, n);
            })
          : W(
  ...
  C.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" == (s = void 0 === n ? "undefined" : _typeof(n)) &&
          (o = te.exec(n)) &&
          o[1] &&
          ((n = ae(e, t, o)), (s = "number")),
          null != n &&
                  ...
                  .on("keypress.mask", function (e) {
                    if (!f.prop("readonly")) {
                      ...
                      e.ctrlKey ||
                        ...
                        13 === i ||
                        (o.end - o.begin != 0 &&
                          (d(o.begin, o.end), c(o.begin, o.end - 1)),
                        (s = l(o.begin - 1)) < T &&
                          ((t = String.fromCharCode(i)), y[s].test(t)) &&
                          ((function (e) {
                            var t, n, i, o;
                            for (n = a((t = s)); t < T; t++)
                              if (y[t]) {
